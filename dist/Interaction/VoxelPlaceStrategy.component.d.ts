...
declare class Data {
    getState(data: PaintVoxelData, picked: VoxelPickResult, alt?: number | null): PaintVoxelData | undefined;
}
export declare const VoxelPlaceStragetgyComponent: import("@amodx/ncs/").ComponentRegisterData<any, Data, any> & {
