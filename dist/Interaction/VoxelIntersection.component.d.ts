...
declare class Data {
    component: (typeof VoxelInersectionComponent)["default"];
    origin: Vec3Array;
    originDirection: Vec3Array;
    pickedPosition: Vec3Array;
    pickedNormal: Vec3Array;
    dataTool: WorldCursor;
    dimension: (typeof DimensionProviderComponent)["default"];
    constructor(component: (typeof VoxelInersectionComponent)["default"]);
    pick(start: Vec3Array, direction: Vec3Array, length: number): import("@divinevoxel/vlox/Voxels/Interaction/VoxelPickResult").VoxelPickResult | null;
}
export declare const VoxelInersectionComponent: import("@amodx/ncs/").ComponentRegisterData<any, Data, any> & {
