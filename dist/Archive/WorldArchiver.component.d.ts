import { ArchivedAreaData } from "@divinevoxel/vlox/World/Archive/Types";
declare class Data {
    component: (typeof WorldArchiverComponent)["default"];
    constructor(component: (typeof WorldArchiverComponent)["default"]);
    archive(): Promise<ArchivedAreaData>;
    load(data: ArchivedAreaData): Promise<void>;
}
export declare const WorldArchiverComponent: import("@amodx/ncs/").ComponentRegisterData<any, Data, any> & {
