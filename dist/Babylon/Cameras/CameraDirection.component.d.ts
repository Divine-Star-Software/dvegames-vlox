...
declare class Data {
    ...
    forwardXZDirection: Vector3;
    forwardRay: Ray;
    private _direction;
    get camera(): import("@babylonjs/core").Camera;
    constructor(_data: (typeof CameraProviderComponent)["default"]["data"]);
    private get2dDirection;
    getForwardDirectionName(): import("@amodx/math").CompassDirections;
    getBackwardDirectionName(): import("@amodx/math").CompassDirections;
    getRightDirectionName(): import("@amodx/math").CompassDirections;
    getLeftDirectionName(): import("@amodx/math").CompassDirections;
    update(): void;
}
export declare const CameraDirectionComponent: import("@amodx/ncs/").ComponentRegisterData<any, Data, any> & {
