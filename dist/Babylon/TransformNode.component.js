...
export const TransformNodeComponent = NCS.registerComponent({
    ...
    init(component) {
        ...
        const transformNode = new TransformNode(`transform-component-${component.node.index}`, context.scene);
        ...
        if (component.schema.mode == "proxy") {
            createTransformProxy(tranform, transformNode.position, transformNode.rotation, transformNode.scaling);
        }
